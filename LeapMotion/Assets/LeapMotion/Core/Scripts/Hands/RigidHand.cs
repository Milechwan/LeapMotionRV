            ...
            for (int f = 0; f < fingers.Length; ++f)
            {
                if (fingers[f] != null)
                {
                    ...
                    if (concluido)
                    {
                        ...
                        if (contadorNumeroDeExercicios < exerciciosBolean.Length)//trocar essa lógica pois nem todos os exercícios vão ser necessariamente executados
                        {
                   ...
                   // Debug.Log("Angulo pontas dos dedos: "+anguloMidiAnelar);
                    ...
                    // 
                        ...
                        else if (exerciciosBolean[5]) //pinchInd
                        {
                            ...
                            nome_exercicio.text = "Contador de Pinça (Indicador): ";
                            info_exercicio.enabled = true;
                        ...
                        else if (exerciciosBolean[6])//pinchMed
                        {
                            ...
                            nome_exercicio.text = "Contador de Pinça (Médio): ";
                            exercicioConcluido.enabled = false;
                            //dedo médio
                        ...
                        else if (exerciciosBolean[7])//pinchAnl
                        {
                            ...
                            nome_exercicio.text = "Contador de Pinça (Anelar): ";
                            exercicioConcluido.enabled = false;
                        ...
                        else if (exerciciosBolean[8])//pinchMindi
                        {
                            ...
                            nome_exercicio.text = "Contador de Pinça (Mindinho): ";
                            //mindinho
